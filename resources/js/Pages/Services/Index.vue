        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-6 text-end">
                    <Link href="/admin/service/create" class="btn btn-danger btn-rounded btn-icon p-2"> Create
                        New Service </Link>
                </div>
            </div>
                        ...
                        <div class="col-sm-12 col-md-3 offset-md-6 ml-auto">
                            <div id="order-listing_filter" class="dataTables_filter">
                                <label class="w-100">
                                    ...
                                    name="searchVal" v-model="search.value" @keyup="searchService()"
                                    ...
                                    <tbody>
                                        <tr v-for="service in services.data" :key="service.id">
                                            ...
                                            <td> {{ service.title.length > 20 ? service.title.slice(0, 20) + '...' :
                                                service.title }} </td>
                                            <td> {{ service.summary.length > 20 ? service.summary.slice(0, 20) + '...' :
                                                service.summary }} </td>
                                            <td>
