                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" @submit.prevent="updateService()">
                                        ...
                                        <!-- Icon -->
                                        <div class="form-group">
                                            <label for="icon"> <i class="mdi mdi-file-image"></i> Upload Icon
                                                <a :href="'/storage/images/services/' + service.icon" class="p-2">
                                                    <img :src="'/storage/images/services/' + service.icon"
                                                        class="icon-service rounded" alt="icon-service" height="60">
                                                </a>
                                            </label>
                                        ...
                                        <div class="form-group">
                                            <label for="img"> <i class="mdi mdi-file-image"></i> Upload Big Image
                                                <a :href="'/storage/images/services/' + service.img" class="p-2">
                                                    <img :src="'/storage/images/services/' + service.img"
                                                        class="img-service rounded" alt="img-service" height="60">
                                                </a>
                                            </label>
