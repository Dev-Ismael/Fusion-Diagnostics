                ...
                <div class="card-body">
                    ...
                    <form class="forms-sample" @submit.prevent="updateService()">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control" placeholder="Type Service Title Here..."
                                v-model="service.title" :class=" errors.title ? 'border-danger' : ''  " >
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control" name="icon" id="icon" placeholder="Upload Icon"
                                @input="service.icon = $event.target.files[0]"  :class=" errors.icon ? 'border-danger' : ''  " >
...
<script>
    ...
    export default {
        ...
        methods: {
            updateService() {
                this.$inertia.put('/admin/service/' + this.service.id, this.service);
            }
        },
    }
