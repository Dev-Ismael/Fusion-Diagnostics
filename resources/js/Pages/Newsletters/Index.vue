        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-6 text-end">
                    <Link href="/admin/newsletter/create" class="btn btn-danger btn-rounded btn-icon p-2"> Create
                        New Newsletter </Link>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-3 offset-md-6 ml-auto">
                            <div id="order-listing_filter" class="dataTables_filter">
                                <label class="w-100">
                                    <input type="text" class="form-control w-100" placeholder="Search By Newsletter Subject..."
                                    name="searchVal" v-model="search.value" @keyup="searchNewsletter()"
