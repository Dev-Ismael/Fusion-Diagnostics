                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 text-end">
                                    <Link href="/admin/testimonial/create"
                                            ...
                                            <div id="order-listing_filter" class="dataTables_filter">
                                                <label class="w-100">
                                                    <input type="text" class="form-control w-100"
                                                        ...
                                                        v-model="search.value" @keyup="searchTestimonial()"
                                                ...
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        <tr v-for="testimonial in testimonials.data"
                                                            ...
                                                            <td> {{ testimonial.name.length > 20 ?
                                                                    testimonial.name.slice(0, 20) + '...' :
                                                                    testimonial.name
                                                            }} </td>
                                                            <td> {{ testimonial.content.length > 20 ?
                                                                    testimonial.content.slice(0, 20) + '...' :
                                                                    testimonial.content
                                                            }} </td>
                                                            <td>
                                                                ...
                                                                &nbsp;
                                                                <Link
                                                                    :href="('/admin/testimonial/' + testimonial.id + '/edit')"
