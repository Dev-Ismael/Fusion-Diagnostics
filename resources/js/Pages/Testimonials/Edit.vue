                                ...
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" @submit.prevent="updateTestimonial()">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="content" :class="errors.content ? 'border-danger' : ''"
                                                class="form-control" id="content" v-model="form.content" cols="30"
                                                rows="10"></textarea>
                                        ...
                                        <div class="form-group">
                                            <label for="img"> <i class="mdi mdi-file-image"></i> Upload Client Image
                                                <a :href="'/storage/images/testimonials/' + testimonial.img"
                                                    class="p-2">
                                                    <img :src="'/storage/images/testimonials/' + testimonial.img"
                                                        class="img-testimonial" alt="img-testimonial" height="60">
                                                </a>
                                            </label>
